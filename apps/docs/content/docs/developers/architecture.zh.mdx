---
title: Architecture
description: Technical architecture of the Hira platform.
---

## Overview

Hira is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `hira` (CLI + daemon), `migrate`
