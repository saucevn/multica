---
title: Contributing
description: Local development workflow for contributors working on the Hira codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `hira` | `hira_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U hira -d postgres \
