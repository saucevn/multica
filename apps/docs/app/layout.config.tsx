...
// Docs-local stateless Hira mark — matches @hira-vn/ui's HiraIcon
...
// packages/ui/components/common/hira-icon.tsx if the mark changes.
const HIRA_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / Hira asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">Hira Docs</span>
    ),
  },
  links: [
    {
      ...
      url: "https://github.com/hira-vn/hira",
      external: true,
    },
    {
      icon: <HiraMark />,
      text: externalLinkText("Hira"),
      url: "https://hira.vn",
      external: true,
    },
  ],
