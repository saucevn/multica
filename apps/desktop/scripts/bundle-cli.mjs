#!/usr/bin/env node
// Builds the `hira` CLI from server/cmd/hira and copies the binary
...
//
// ldflags mirror `make build` so `hira --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "hira.exe" : "hira";
}
