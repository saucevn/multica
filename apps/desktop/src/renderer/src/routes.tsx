...
import { IssuesPage } from "@hira-vn/views/issues/components";
import { ProjectsPage } from "@hira-vn/views/projects/components";
import { AutopilotsPage } from "@hira-vn/views/autopilots/components";
import { MyIssuesPage } from "@hira-vn/views/my-issues";
import { SkillsPage } from "@hira-vn/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { AgentsPage } from "@hira-vn/views/agents";
import { InboxPage } from "@hira-vn/views/inbox";
import { ChatPage } from "@hira-vn/views/chat";
import { SettingsPage } from "@hira-vn/views/settings";
