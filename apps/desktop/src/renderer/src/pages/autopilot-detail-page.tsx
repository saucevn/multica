...
import { AutopilotDetailPage as AutopilotDetail } from "@hira-vn/views/autopilots/components";
import { useWorkspaceId } from "@hira-vn/core/hooks";
import { autopilotDetailOptions } from "@hira-vn/core/autopilots/queries";
