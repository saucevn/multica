...
const SAMPLE_LATEST_ASSET = {
  name: "hira-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/hira-vn/hira/releases/download/v0.2.14/hira-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "hira-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/hira-vn/hira/releases/download/v0.2.13/hira-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/hira-vn/hira/releases/tag/${overrides.tag}`,
