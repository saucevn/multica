...
/**
 * Server-side fetcher for the latest Hira release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/hira-vn/hira/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Hira doesn't publish prereleases or drafts
