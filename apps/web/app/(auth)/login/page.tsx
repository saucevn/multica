...
import { LoginPage, validateCliCallback } from "@hira-vn/views/auth";
      ...
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {desktopToken
                ? "You should see a prompt to open the Hira desktop app. If nothing happens, click the button below."
