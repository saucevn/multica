...
import { captureDownloadPageViewed } from "@hira-vn/core/analytics";

const ALL_RELEASES_URL =
  "https://github.com/hira-vn/hira/releases";
  ...
  return (
    <>
      {/* Positioning context for the dark-variant LandingHeader —
          mirrors hira-landing.tsx. The header is `absolute top-0
