...
#   $env:HIRA_MODE="local"; irm https://raw.githubusercontent.com/hira-vn/hira/main/scripts/install.ps1 | iex
#
...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/hira-vn/hira.git"
$RepoWebUrl    = "https://github.com/hira-vn/hira"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/hira-vn/hira/releases/latest" -ErrorAction Stop
...
function Get-SelfHostRef {
    if ($env:HIRA_SELFHOST_REF) {
        return $env:HIRA_SELFHOST_REF
    }
...
function Install-CliBinary {
    ...
    $url = "https://github.com/hira-vn/hira/releases/download/$latest/hira-cli-$version-windows-$arch.zip"
    ...
    $checksumUrl = "https://github.com/hira-vn/hira/releases/download/$latest/checksums.txt"
    try {
        ...
        $expectedLine = ($checksums.Content -split "`n") | Where-Object { $_ -match "hira-cli-$version-windows-$arch\.zip" } | Select-Object -First 1
        if ($expectedLine) {
...
function Install-Server {
    ...
    Write-Info "Pulling official Hira images..."
...
function Start-DefaultInstall {
    ...
    Write-Host '     $env:HIRA_MODE="with-server"; irm https://raw.githubusercontent.com/hira-vn/hira/main/scripts/install.ps1 | iex'
    Write-Host ""
}
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:HIRA_MODE="stop"; irm https://raw.githubusercontent.com/hira-vn/hira/main/scripts/install.ps1 | iex'
    Write-Host ""
}
