...
} from "@hira-vn/core/inbox/queries";
import {
  useMarkInboxRead,
  useArchiveInbox,
  useMarkAllInboxRead,
...
} from "@hira-vn/core/inbox/mutations";
...
import type { InboxItem } from "@hira-vn/core/types";
...
export function InboxPage() {
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <IssueDetail
      ...
      layoutId="hira_inbox_issue_detail_layout"
