...
import type { Comment, TimelineEntry, Reaction } from "@hira-vn/core/types";
import type {
...
import { issueTimelineOptions, issueKeys } from "@hira-vn/core/issues/queries";
import {
  useCreateComment,
  useUpdateComment,
  useDeleteComment,
...
} from "@hira-vn/core/issues/mutations";
