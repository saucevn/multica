...
import type { Issue, TimelineEntry } from "@hira-vn/core/types";
// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @hira-vn/core/hooks.tsx). vi.mock("@hira-vn/core/paths") only intercepts
...
// Mock @hira-vn/core/workspace/hooks
vi.mock("@hira-vn/core/workspace/hooks", () => ({
  useActorName: () => ({
...
// Mock @hira-vn/core/paths — after the URL-driven workspace refactor,
...
// Mock issue config
vi.mock("@hira-vn/core/issues/config", () => ({
...
vi.mock("@hira-vn/core/issues/stores", () => ({
...
// Mock react-resizable-panels (used by @hira-vn/ui/components/ui/resizable)
