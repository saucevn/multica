...
// Mock @hira-vn/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@hira-vn/core/issues/stores/view-store", () => ({
...
vi.mock("@hira-vn/core/issues/stores/view-store-context", () => ({
  ViewStoreProvider: ({ children }: { children: React.ReactNode }) => children,
  useViewStore: (selector?: any) => (selector ? selector(mockViewState) : mockViewState),
  useViewStoreApi: () => ({ getState: () => mockViewState, setState: vi.fn(), subscribe: vi.fn() }),
}));

vi.mock("@hira-vn/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@hira-vn/core/issues/stores/selection-store", () => ({
...
vi.mock("@hira-vn/core/issues/stores/recent-issues-store", () => ({
