...
import {
  ...
  PRIORITY_ORDER,
  PRIORITY_CONFIG,
} from "@hira-vn/core/issues/config";
...
import { projectListOptions } from "@hira-vn/core/projects/queries";
import { ActorAvatar } from "../../common/actor-avatar";
import {
  SORT_OPTIONS,
  CARD_PROPERTY_OPTIONS,
  type ActorFilterValue,
} from "@hira-vn/core/issues/stores/view-store";
import { useViewStore, useViewStoreApi } from "@hira-vn/core/issues/stores/view-store-context";
import {
  useIssuesScopeStore,
  type IssuesScope,
} from "@hira-vn/core/issues/stores/issues-scope-store";
