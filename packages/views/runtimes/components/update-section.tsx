...
import type { RuntimeUpdateStatus } from "@hira-vn/core/types";

const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/hira-vn/hira/releases/latest";
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {isManaged ? (
          <span
            ...
            title="The CLI binary is managed by Hira Desktop — update Desktop to upgrade the CLI."
          >
            Managed by Desktop
          </span>
        ) : (
