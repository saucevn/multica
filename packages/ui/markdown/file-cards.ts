 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "hira-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "hira-static.copilothub.ai")
 */
